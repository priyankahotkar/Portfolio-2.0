...
const skillsData: SkillCategory[] = [
  ...
  },
  {
    ...
    icon: <Layers size={24} className="text-primary-500" />,
    skills: [ 'Express.js', 'Node.js', 'MongoDB', 'Firebase', 'MySQL', 'Websockets', 'WebRTC'],
  },
  {
    id: 'ai',
    title: 'AI/ML',
  ...
  },
  {
    ...
    skills: ['Data Structures & Algorithms', 'Object-Oriented Programming', 'Low Level Design', 'High Level Design', 'Operating Systems', 'Database Management', 'Software Development Life Cycle'],
  },
  {
    id: 'soft',
    title: 'Soft Skills',
